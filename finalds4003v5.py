     ...
     # sidebar with filters
        ...
        # date picker range
            ...
            html.Div([
                ...
                html.Div([
                    dcc.Graph(id='avg-satisfaction-bar', style={'display': 'inline-block', 'width': '35%', 'minHeight': '540px'}),
                    dcc.Graph(id='absences-salary-line', style={'display': 'inline-block', 'width': '65%', 'minHeight': '540px'}),
                ], style={'display': 'flex', 'width': '100%'}),
...
@app.callback(
    ...
    [Input('department-dropdown', 'value'),
     ...
     Input('date-picker-range', 'start_date'),
     Input('date-picker-range', 'end_date')])
def update_gender_pie_chart(department, position, performance, employment_status, salary_range, age_range, satisfaction, start_date, end_date):
...
@app.callback(
    ...
    [Input('department-dropdown', 'value'),
     ...
     Input('performance-dropdown', 'value'),
     Input('gender-dropdown', 'value'),
     Input('employment-status-dropdown', 'value'),  # Assuming you have added this dropdown
     Input('salary-slider', 'value'),
     Input('age-slider', 'value'),
     Input('satisfaction-checklist', 'value'),
     Input('date-picker-range', 'start_date'),
