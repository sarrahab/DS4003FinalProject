...
app.layout = html.Div(children=[
    ...
    html.P('''
        ...
        # Date picker range
            ...
            ], style={'width': '20%', 'display': 'inline-block', 'verticalAlign': 'top', 'padding': '10px', 'backgroundColor': '#f3f2f4'}),
            ...
            ], style={'width': '75%', 'display': 'inline-block', 'verticalAlign': 'top', 'backgroundColor': '#f3f2f4'}),
        ], style={'display': 'flex', 'width': '100%'}),
    ])
...
def update_gender_pie_chart(department, position, performance, salary_range, age_range, satisfaction, start_date, end_date):
    ...
    pie_chart.update_layout(
        paper_bgcolor='#f3f2f4',  # light gray background
...
def update_absences_line_chart(department, performance, gender, salary_range, age_range, satisfaction, start_date, end_date):
    ...
    fig.update_layout(plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='#f3f2f4', font=dict(color='#4b2e83'))
